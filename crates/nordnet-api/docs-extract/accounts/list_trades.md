...
| Query | days optional | Number of days to use when looking up trades. Defaults to 0, which means trades from today only. Maximum is 7 days. | integer(int64) | "0" |
...
|-----------|-------------|--------|
| 200 | Standard response for successful HTTP requests. | < Trade > array |
...
- [Account](../_definitions/Account.md)
- [ErrorResponse](../_definitions/ErrorResponse.md)
- [Trade](../_definitions/Trade.md)
