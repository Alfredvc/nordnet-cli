# search_bullbearlist — Search, filter and sort instruments within the Bull & Bear entity type.
...
|-----------|-------------|--------|
| 200 | Standard response for successful HTTP requests. | BullBearListResults |
...
- [BullBearListResults](../_definitions/BullBearListResults.md)
