# search_minifuturelist — Search, filter and sort instruments within the Mini future entity type.
...
- **200**: MinifutureListResults

## Status Codes

| HTTP Code | Description | Schema |
|-----------|-------------|--------|
| 200 | Standard response for successful HTTP requests. | MinifutureListResults |
...
- [MinifutureListResults](../_definitions/MinifutureListResults.md)
