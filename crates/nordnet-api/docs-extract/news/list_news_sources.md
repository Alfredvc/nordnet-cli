# list_news_sources — Get news sources
...
- **200**: < NewsSource > array

## Status Codes

| HTTP Code | Description | Schema |
|-----------|-------------|--------|
| 200 | Standard response for successful HTTP requests. | < NewsSource > array |
...
- [NewsSource](../_definitions/NewsSource.md)
