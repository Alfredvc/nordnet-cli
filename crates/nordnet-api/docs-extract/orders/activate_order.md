# activate_order — Activate an order
...
| Path | order_id required | The order(s) to activate. Multiple identifiers must be comma separated. | < integer(int64) > array |
...
- **200**: < OrderReply > array

## Status Codes

| HTTP Code | Description | Schema |
|-----------|-------------|--------|
| 200 | Standard response for successful HTTP requests. | < OrderReply > array |
