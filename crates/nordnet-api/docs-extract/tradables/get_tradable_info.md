# get_tradable_info — Get tradable info
...
|-----------|-------------|--------|
| 200 | Standard response for successful HTTP requests. | < TradableInfo > array |
...
- [TradableInfo](../_definitions/TradableInfo.md)
